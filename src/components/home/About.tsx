    ...
    <section id="sobre" className="section-padding">
      <div className="container-tight space-y-9">
        <header className="max-w-4xl space-y-3">
          ...
          <h2 className="text-3xl font-semibold md:text-4xl">Abordagem de produto: menos ruído, mais decisão bem informada.</h2>
          <p className="text-muted">Meu papel é transformar requisitos difusos em experiência utilizável, com critério técnico e intenção de negócio.</p>
        </header>
